...
const TEAMS = [
  new Team("Alavés", "./assets/img/alaves.png"),
  new Team("Athletic", "./assets/img/athletic.png"),
  new Team("Atlético Madrid", "./assets/img/atletico.png"),
  new Team("Barcelona", "./assets/img/barcelona.png"),
  new Team("Betis", "./assets/img/betis.png"),
  new Team("Cádiz", "./assets/img/cadiz.png"),
  new Team("Celta de Vigo", "./assets/img/celta.png"),
  new Team("Elche C.F.", "./assets/img/elche.png"),
  new Team("RCD Espanyol", "./assets/img/espanyol.png"),
  new Team("Getafe", "./assets/img/getafe.png"),
  new Team("Granada", "./assets/img/granada.png"),
  new Team("Levante", "./assets/img/levante.png"),
  new Team("Real Madrid", "./assets/img/madrid.png"),
  new Team("R.C.D. Mallorca", "./assets/img/mallorca.png"),
  new Team("Osasuna", "./assets/img/osasuna.png"),
  new Team("Rayo Vallecano", "./assets/img/rayo.png"),
  new Team("Real Sociedad", "./assets/img/real.png"),
  new Team("Sevilla", "./assets/img/sevilla.png"),
  new Team("Valencia C.F.", "./assets/img/valencia.png"),
  new Team("Villarreal", "./assets/img/villarreal.png"),
];
