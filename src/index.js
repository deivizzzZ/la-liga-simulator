...
const TEAMS = [
  new Team("Alavés", "./public/img/alaves.png"),
  new Team("Athletic", "./public/img/athletic.png"),
  new Team("Atlético Madrid", "./public/img/atletico.png"),
  new Team("Barcelona", "./public/img/barcelona.png"),
  new Team("Betis", "./public/img/betis.png"),
  new Team("Cádiz", "./public/img/cadiz.png"),
  new Team("Celta de Vigo", "./public/img/celta.png"),
  new Team("Elche C.F.", "./public/img/elche.png"),
  new Team("RCD Espanyol", "./public/img/espanyol.png"),
  new Team("Getafe", "./public/img/getafe.png"),
  new Team("Granada", "./public/img/granada.png"),
  new Team("Levante", "./public/img/levante.png"),
  new Team("Real Madrid", "./public/img/madrid.png"),
  new Team("R.C.D. Mallorca", "./public/img/mallorca.png"),
  new Team("Osasuna", "./public/img/osasuna.png"),
  new Team("Rayo Vallecano", "./public/img/rayo.png"),
  new Team("Real Sociedad", "./public/img/real.png"),
  new Team("Sevilla", "./public/img/sevilla.png"),
  new Team("Valencia C.F.", "./public/img/valencia.png"),
  new Team("Villarreal", "./public/img/villarreal.png"),
];
